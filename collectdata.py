...
while True:
    ...
    row = frame.shape[1]
    col = frame.shape[0]
    cv2.rectangle(frame,(0,40),(300,400),(255,255,255),2)       # Designing a Frame
    cv2.imshow("data",frame)
    cv2.imshow("ROI",frame[40:400,0:300])       # Cutting a smaller frame for actual image size.
...
# After publishing destroy all windows.
cap.release()
